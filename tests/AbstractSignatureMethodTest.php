...
use Techloco\TwitterOAuth\SignatureMethod;
...
abstract class AbstractSignatureMethodTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMockBuilder('Techloco\TwitterOAuth\Request')
    ...
    {
        return $this->getMockBuilder('Techloco\TwitterOAuth\Consumer')
    ...
    {
        return $this->getMockBuilder('Techloco\TwitterOAuth\Token')
